...
"i686-linux-thread-multi-2.4.27-3-386" or
	die "Errno architecture (i686-linux-thread-multi-2.4.27-3-386) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
